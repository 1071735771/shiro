    ...
    <div class="box box-solid mydatagrid">
        ...
        <div class="box-body" style="display: block;align:center">
            <div id="search" style="padding:3px" class="pull-left">
                ...
                <label>路径:</label>
                <input type="text" id="src" name="src" style="padding:6px 12px;">
...
<script>
    ...
    function loadGrid() {
        ...
        $('#dataGrid').datagrid({
            ...
            method: 'post',
            columns: [[
                { field: '0',title: '操作人',width: '30%', align: 'center', sortable: false},
                { field: '1',title: '操作时间',width: '30%',align: 'center',sortable: false,formatter:function (value,row,index) {
                    return formatDate(new Date(value));
                }},
                { field: '2',title: '源目录',width: '30%',align: 'center',sortable: false},
