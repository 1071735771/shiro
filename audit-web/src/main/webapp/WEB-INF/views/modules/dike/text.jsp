    ...
    <div class="box box-solid mydatagrid">
        ...
        <div class="box-body" style="display: block;align:center">
            <div id="search" style="padding:3px" class="pull-left">
                ...
                <%--<label>操作类型:</label>--%>
                <%--<select id="optype">--%>
                    <%--<option value="1">web行为跟踪</option>--%>
                    <%--<option value="2">系统行为跟踪</option>--%>
                <%--</select>--%>
...
<script>
        ...
        onSelect : function(beginDate){
            ...
            $('#endTime').datebox().datebox('calendar').calendar({
                validator: function(date){
                    return date - beginDate <  2 * 24 * 60 * 60 * 1000 && date > beginDate ;
                }
            });
        }
    });
    ...
    function loadGrid() {
        ...
        $('#dataGrid').datagrid({
            ...
            method: 'post',
            columns: [[
                { field: '0',title: '用户名',width: '10%', align: 'center', sortable: false},
                { field: '1',title: '操作时间',width: '12%',align: 'center',sortable: false,formatter:function (value,row,index) {
                    return formatDate(new Date(value));
                }},
                { field: '2',title: '系统名称',width: '10%',align: 'center',sortable: false},
                { field: '3',title: '模块名称',width: '10%',align: 'center',sortable: false},
                { field: '4',title: '按钮名称',width: '10%',align: 'center',sortable: false},
                { field: '5',title: '操作类型',width: '10%',align: 'center',sortable: false},
                { field: '6',title: '操作内容',width: '10%',align: 'center',sortable: false},
                { field: '7',title: '操作结果',width: '10%',align: 'center',sortable: false},
                { field: '8',title: '终端IP',width: '10%',align: 'center',sortable: false}
            ]],
            //列排序时触发方法
    ...
    function doSearch(sortName, sortValue) {
        ...
        //var optype=  $("#optype").find("option:selected").val();
