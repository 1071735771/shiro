        ...
        <div class="box-body" style="display: block;align:center">
            <div id="search" style="padding:3px" class="pull-left">
                ...
                <select id="location" onchange="downs();">
                    ...
                    <option value="<%=basePath%>/admin/dike/index_7">7数据同步行为</option>
                </select>

                <label>操作人:</label>
                <input type="text" id="webusername" name="webusername" style="padding:6px 12px;">

                <label>事件ID:</label>
                <input type="text" id="noticeId" name="noticeId" style="padding:6px 12px;">
...
<script>
    ...
    function loadGrid() {
        ...
        $('#dataGrid').datagrid({
            ...
            method: 'post',
            columns: [[
                { field: '0',title: '操作人',width: '18%', align: 'center', sortable: false},
                { field: '1',title: '事件ID',width: '20%', align: 'center', sortable: false},
                { field: '2',title: '主机IP',width: '18%', align: 'center', sortable: false},
                { field: '3',title: '描述',width: '20%', align: 'center', sortable: false},
                { field: '4',title: '操作时间',width: '20%',align: 'center',sortable: false,formatter:function (value,row,index) {
                    return formatDate(new Date(value));
                }},
                { field: '5',title: '结果',width: '18%', align: 'center', sortable: false,formatter:function (value,row,index) {
                    if(value == "1" ){
                        return "成功";
                    }else {
                        return "失败";
