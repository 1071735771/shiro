    ...
    <div class="box box-solid mydatagrid">
        ...
        <div class="box-body" style="display: block;align:center">
            <div id="search" style="padding:3px" class="pull-left">
                ...
                <label>操作人:</label>
                <input type="text" id="opUser" name="opUser" style="padding:6px 12px;">

                <label>名称:</label>
                <input type="text" id="sysName" name="sysName" style="padding:6px 12px;">
    ...
    function loadGrid() {
        ...
        $('#dataGrid').datagrid({
            ...
            columns: [[
                ...
                { field: '2',title: '系统名称',width: '20%', align: 'center', sortable: false},
                { field: '3',title: '操作模块',width: '18%', align: 'center', sortable: false},
                { field: '4',title: '操作按钮',width: '20%', align: 'center', sortable: false},
                { field: '5',title: '操作类型',width: '20%', align: 'center', sortable: false},
                { field: '6',title: '操作结果',width: '18%', align: 'center', sortable: false}
            ]],
            //列排序时触发方法
