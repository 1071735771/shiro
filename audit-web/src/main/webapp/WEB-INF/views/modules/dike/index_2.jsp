    ...
    <div class="box box-solid mydatagrid">
        ...
        <div class="box-body" style="display: block;align:center">
            <div id="search" style="padding:3px" class="pull-left">
               ...
               <label>门户用户:</label>
                <input type="text" id="portalsUser" name="portalsUser" style="padding:6px 12px;">


                <label>操作人:</label>
                <input type="text" id="Hname" name="Hname" style="padding:6px 12px;">
...
<script>
    ...
    function loadGrid() {
        ...
        $('#dataGrid').datagrid({
            ...
            method: 'post',
            columns: [[
                { field: '0',title: '门户用户',width: '15.2%', align: 'center', sortable: false},
                { field: '1',title: '操作人',width: '15.2%',align: 'center',sortable: false},
                { field: '2',title: '操作时间',width: '15.2%',align: 'center',sortable: false,formatter:function (value,row,index) {
                 return formatDate(new Date(value));
                 }},
                { field: '3',title: '库名',width: '15.2%',align: 'center',sortable: false},
                { field: '4',title: '表名',width: '15.2%',align: 'center',sortable: false},
                { field: '5',title: '命令',width: '15.2%',align: 'center',sortable: false},
            ]],
            //列排序时触发方法
    ...
    function doSearch(sortName, sortValue) {
        var portalsUser=$("#portalsUser").val();
        var Hname=$("#Hname").val();
