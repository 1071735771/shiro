...
<head>
  ...
  <link rel="stylesheet" href="${basePath}/statics/modules/sys/css/login.css">
  <!-- jQuery 2.2.0 -->
...
<body class="hold-transition login-page login_bg_it_num" onload="loadTopWindow()">

<div class="login-box" ><!--background: url(${basePath}/statics/modules/sys/img/login_logo.png) ;-->

  <div class="login-logo" style="width:307px; height:38px; margin-bottom:25px;margin-left: 40px;">
  </div>
...
<!-- login -->
<script type="text/javascript" src="${basePath}/statics/modules/sys/js/login.js"></script>
