 ...
 */
@Entity
@Table(name = "dop_mining_loginfo_201709", schema = "audit", catalog = "")
public class DopMiningLoginfo_201709 extends AutoModel {
    ...
    @Basic
    @Column(name = "open_url", nullable = true, length = 300)
