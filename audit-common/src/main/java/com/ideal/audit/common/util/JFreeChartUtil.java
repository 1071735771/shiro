...
/**
 * Created by ybb on 2017/11/21 18:20
 *
 * @Description :
 * @ModifyBy:
 */
public class JFreeChartUtil extends ApplicationFrame{

        public JFreeChartUtil(String title)
        {
            super(title);
        ...
        {
            JFreeChartUtil chart=new JFreeChartUtil("某公司组织结构图");
            chart.pack();//以合适的大小显示
